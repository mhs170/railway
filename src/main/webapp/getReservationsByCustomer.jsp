     ...
     try {
		...
		if(action.equals("search")){
			...
			if(rs.next()){
                %>
                <div class="container">
                    	<div><b>Reservation Data for <%= rs.getString("l_name") + ", " + rs.getString("f_name")%> (username: <%=rs.getString("username") %>)</b></div>
                    <table>
                        <tr>
                            ...
                            <th>Total Fare</th>
                            <th><%= rs.getString("transit_line_name") %></th>
                        </tr>
                        <% 
                ...
                %>
                <div class="container">
                    <h3>No reservation data found for the selected customer.</h3>
                </div>
                <%
            } 
%>
